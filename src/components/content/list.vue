...
const sortOptions = [
  ...
  { id: "date-asc", name: "data de estreia ▴" },
  { id: "date-desc", name: "data de estreia ▾" },
];
        ...
        <div class="relative mt-1 min-w-[200px]">
          ...
          >
            ...
            >
              <li
                :class="[
                  active ? 'bg-lightBlue text-stone-800' : 'text-lightBlue',
              ...
              >
                ...
                <span
                  v-if="selected"
                  :class="[active ? 'fill-stone-800' : 'fill-lightBlue']"
